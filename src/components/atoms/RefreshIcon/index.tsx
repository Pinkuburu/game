...
class RefreshIcon extends React.PureComponent<IProps, IState> {
  countDown: React.RefObject<CountDown>;
  ...
  handleRefresh() {
    // TODO: 仿照旧项目 添加svg旋转
    this.countDown.current && this.countDown.current.reset();
    this.props.onRefresh && this.props.onRefresh();
  }

  render() {
    return (
      <span className={styles.countDownContainer} onClick={this.handleRefresh}>
        <svg width="28px" height="28px" viewBox="0 0 28 28" version="1.1">
          ...
          <g id="1.0.0首页" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g
              id="1.0.2首页_赛程结果"
              transform="translate(-222.000000, -414.000000)"
              fill="#CA59FF"
            >
